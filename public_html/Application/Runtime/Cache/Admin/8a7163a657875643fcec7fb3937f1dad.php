...
<html>
  <head>
    ...
    <title>咨询领域-<?php echo (C("WEB_NAME")); ?></title>
  ...
  <form action="/Admin/Index/doctype" method="POST">
...
<tr><td><div class="num-p con-color con-font con-pd-l con-mb" style="height:30px;margin-top:0px;padding-top:0px;margin-bottom:15px;padding-bottom:5px;"><div class="col-50">领域简介：<textarea name="content" type="text" class="input-text" style="border-style:none;width:70%;"></textarea></div></div></td></tr>
  ...
  <?php if(is_array($consultationtype)): $i = 0; $__LIST__ = $consultationtype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$consultationtype): $mod = ($i % 2 );++$i;?><div class="food-p con-font con-color con-pd con-mb">
  <form action="/Admin/Index/editctype/id/<?php echo ($consultationtype["id"]); ?>/" method="POST">
  <table cellpadding="0" cellspacing="0" class="data-table">
<tr><td><div class="num-p con-color con-font con-pd-l con-mb" style="height:30px;margin-top:0px;padding-top:0px;margin-bottom:5px;padding-bottom:5px;"><div class="col-50">领域标题：<input name="title" type="text" class="input-text" value="<?php echo ($consultationtype["title"]); ?>" style="border-style:none;width:70%;"></div></div></td></tr>
<tr><td><div class="num-p con-color con-font con-pd-l con-mb" style="height:30px;margin-top:0px;padding-top:0px;margin-bottom:15px;padding-bottom:5px;"><div class="col-50">领域简介：<textarea name="content" type="text" class="input-text" style="border-style:none;width:70%;"><?php echo ($consultationtype["content"]); ?></textarea></div></div></td></tr>
