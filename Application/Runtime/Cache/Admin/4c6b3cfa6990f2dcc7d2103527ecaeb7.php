...
<html>
  ...
  <form method="post" action="/Admin/Index/smoneysupport/">
   ...
   <div class="lists">
    ...
    <div class="col-20">
      <ul class="actions">
       <?php if($smoneysupport['status']==1): ?><li class="bor-l"><a href="/Admin/Index/domoneysupport/id/<?php echo ($smoneysupport["id"]); ?>/status/2/"><img src="/Public/template/admin/images/icon_gou0.png" alt=""/></a></li>
