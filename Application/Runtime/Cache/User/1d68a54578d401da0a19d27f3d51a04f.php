...
<form class="am-form" action="/User/Index/dosupportm" method="POST">
  <fieldset style="padding-bottom:0px;margin-bottom:-22px;">
    ...
    <div class="am-form-group" style="float:left;margin-bottom:8px;">
	  <div style="float:left;"><i class="am-icon-bank"></i>&nbsp银&nbsp&nbsp&nbsp行 <B><?php echo (C("WEB_BANKNAME")); ?></B>&nbsp&nbsp<i class="am-icon-user-md"></i>&nbsp户名 <B><?php echo (C("WEB_CARDNAME")); ?></B> </div>
	  <div style="float:left;"><i class="am-icon-hospital-o"></i>&nbsp开户行 <B><?php echo (C("WEB_ACCOUNTBANK")); ?></B>&nbsp&nbsp<i class="am-icon-user"></i>&nbsp账号 <B><?php echo (C("WEB_BANKCARDID")); ?></B></div>
