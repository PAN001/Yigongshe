...
<html>
  ...
  <body>
    <div class="content-box no-top">
       <div class="main-con">
        <?php if(is_array($video)): $i = 0; $__LIST__ = $video;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$video): $mod = ($i % 2 );++$i;?><a href="<?php echo ($video["url"]); ?>"><div class="con-font con-pd bgcolor-w con-mb">
              <div class="row v-bg video-item">
              <img src="<?php echo ($video["thumb"]); ?>" style="height:100%;width:100%;">
              </div>
              <p style="color:#000"><?php echo ($video["title"]); ?><span style="float:right;"><?php echo ($video["date"]); ?></span></p>
    ...
    <a class="tab-item external active" href="/Home/Index/video">
